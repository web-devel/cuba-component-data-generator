...
public class DatagenTestContainer extends TestContainer {

    public DatagenTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/datagen/app.properties",
    ...
    public static class Common extends DatagenTestContainer {

        public static final DatagenTestContainer.Common INSTANCE = new DatagenTestContainer.Common();
